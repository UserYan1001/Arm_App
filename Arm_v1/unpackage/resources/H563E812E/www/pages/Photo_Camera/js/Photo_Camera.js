...
function addPhotoToGallery(filePath, fileName) {
    ...
    if (fileName.includes('机体遥控')) {
        prefix = '机体遥控';
    } else if (fileName.includes('色块追踪')) {
        prefix = '色块追踪';
    }else if (fileName.includes('色块分拣')) {
        prefix = '色块分拣';
    }else if (fileName.includes('色块码垛')) {
        prefix = '色块码垛';
    }else if (fileName.includes('码块分拣')) {
        prefix = '码块分拣';
    }else if (fileName.includes('码块码垛')) {
        prefix = '码块码垛';
    }else if (fileName.includes('数块分拣')) {
        prefix = '数块分拣';
    }else if (fileName.includes('数块码垛')) {
        prefix = '数块码垛';
    }else if (fileName.includes('人脸追踪')) {
        prefix = '人脸追踪';
    }
